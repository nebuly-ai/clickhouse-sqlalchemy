...
from sqlalchemy.sql import roles, type_api
from sqlalchemy.sql.elements import BindParameter, ClauseList, ColumnElement
...
class LimitByClause:
    ...
    def __init__(self, by_clauses, limit, offset):
        self.by_clauses = ClauseList(*by_clauses, _literal_as_text_role=roles.ByOfRole)
