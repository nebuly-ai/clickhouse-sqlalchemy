...
class MockedEngine(object):
    ...
    def __enter__(self):
        ...
        self.prev_get_server_version_info = self.dialect_cls._get_server_version_info
        self.prev_get_default_schema_name = self.dialect_cls._get_default_schema_name
    ...
    def __exit__(self, *exc_info):
        ...
        self.dialect_cls._get_server_version_info = self.prev_get_server_version_info
        self.dialect_cls._get_default_schema_name = self.prev_get_default_schema_name
