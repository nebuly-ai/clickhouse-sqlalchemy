...
class GetInnerSpecTestCase(TestCase):
    def test_get_inner_spec(self):
        self.assertEqual(get_inner_spec("DateTime('Europe/Paris')"), "'Europe/Paris'")
...
class ParseArgumentsTestCase(TestCase):
    def test_parse_arguments(self):
        ...
        self.assertEqual(
            parse_arguments("anyIf, String, UInt8"), ("anyIf", "String", "UInt8")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            parse_arguments("Float32, Decimal(18, 2)"), ("Float32", "Decimal(18, 2)")
        )
        self.assertEqual(
